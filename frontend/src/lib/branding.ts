...
const defaultIconSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><defs><linearGradient id="ct" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#9273c9"/><stop offset="1" stop-color="#b39ddb"/></linearGradient></defs><rect width="48" height="48" rx="12" fill="url(#ct)"/><g transform="translate(12 12)" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="${TICKET_OUTLINE}"/><path d="${TICKET_NOTCHES}"/></g></svg>`
